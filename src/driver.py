...
from cloudshell.networking.brocade.runners.brocade_connectivity_runner import \
    BrocadeConnectivityRunner as ConnectivityRunner
from cloudshell.networking.brocade.runners.brocade_configuration_runner import \
    BrocadeConfigurationRunner as ConfigurationRunner
...
class BrocadeNetIronShellDriver(ResourceDriverInterface, NetworkingResourceDriverInterface, GlobalLock):
    SUPPORTED_OS = [r"Brocade.+MLX.+IronWare"]
    SHELL_NAME = "Brocade NetIron Router 2G"
    # SHELL_NAME = ""

    def __init__(self):
        super(BrocadeNetIronShellDriver, self).__init__()
        self._cli = None
